...
function cuentoElementos(array) {
   ...
   for (let i = 0; i<array.length; i++) {
      ...
      if (currentNumber > 18) {
        mayorDiesiocho.push(currentNumber)
      }
    }
   return mayorDiesiocho.length;
}
...
function mayorACien(array) {
   ...
   for (let i = 0; i<array.length; i++) {
      var currentNumber = array[i];
      if (currentNumber > 100 &&  currentNumber<200 !==100) {
        mayorCien.push(currentNumber);
      }
    }
   return mayorCien;
}
...
function breakStatement(num) {
   ...
   for (var i = 0; i<10; i++) {
      ...
      if (currentNumber === i) { 
         ...
         masDos.push(currentNumber);
      }
   }
   if(masDos.length < 10){
      return "Se interrumpió la ejecución";
   }else if(masDos.length ===10 ){
      return masDos;
   }
